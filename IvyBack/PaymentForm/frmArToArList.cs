...
{
    public partial class frmArToArList : Form, IOrderList
    {


        public frmArToArList( )
        {
            ...
            dataGrid1.AddColumn("supcust_from", "转入客户编号", "", 150, 1, "");
            dataGrid1.AddColumn("supcust_from_name", "转入客户名称", "", 150, 1, "");//
            dataGrid1.AddColumn("supcust_to", "转出客户编号", "", 150, 1, "");
            dataGrid1.AddColumn("supcust_to_name", "转出客户名称", "", 150, 1, ""); //          
            ...
            try
            {
                ...
                System.Threading.Thread th = new System.Threading.Thread(() =>
                {
                    ...
                    try
                    {
                        ...
                        DataTable tb = paymentbll.GetArApList(date1, date2, text,text1, "RR");
