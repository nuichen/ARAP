...
{
    public partial class frmArToApList : Form, IOrderList
    {


        public frmArToApList( )
        {
            ...
            dataGrid1.AddColumn("supcust_from", "客户编号", "", 150, 1, "");
            dataGrid1.AddColumn("supcust_from_name", "客户名称", "", 150, 1, "");//
            dataGrid1.AddColumn("supcust_to", "供应商编号", "", 150, 1, "");
            dataGrid1.AddColumn("supcust_to_name", "供应商名称", "", 150, 1, ""); //          
            ...
            this.myTextBox2.Bind(bll.GetDataTable("", "", 1, 1, 20000, out tmp), 300, 200, "supcust_no", "supcust_no:客户编码:100,sup_name:客户名称:150",
                "supcust_no/sup_name->Text");
            this.myTextBox1.Bind(bll1.GetDataTable("", "", 1, 1, 20000, out tmp), 300, 200, "supcust_no", "supcust_no:供应商编码:100,sup_name:供应商名称:150",
               "supcust_no/sup_name->Text");
        }
        ...
        private void refreshData()
        {
            try
            {
                ...
                string text = myTextBox2.Text.Split('/')[0];
                string text1 = myTextBox1.Text.Split('/')[0];
                System.Threading.Thread th = new System.Threading.Thread(() =>
                {
                    ...
                    try
                    {
                        ...
                        DataTable tb = paymentbll.GetArApList(date1, date2, text,text1, "OR");
                ...
                if (sheet_no != row["sheet_no"].ToString())
                {
                    System.Threading.Thread th = new System.Threading.Thread(() =>
                    {
                        ...
                        try
                        {
                            ...
                            System.Data.DataTable tb1;
                            System.Data.DataTable tb2;
                            paymentbll.GetArApOrder(sheet_no,out tb2);
                            //string is_cs = "S";
                            //bll.GetOrder(sheet_no,is_cs, out tb1, out tb2);
