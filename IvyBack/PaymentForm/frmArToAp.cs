...
{
    public partial class frmArToAp : Form, IOrder
    {
            ...
            try
            {
                ...
                System.Threading.Thread th = new System.Threading.Thread(() =>
                {
                    ...
                    try
                    {
                        ...
                        this.txtcus.Invoke((MethodInvoker)delegate
                        {
                            this.txtsup.Bind(bll1.GetDataTable("", "", 1, 1, 20000, out tmp), 300, 200, "supcust_no", "supcust_no:供应商编码:100,sup_name:供应商名称:150", "supcust_no/sup_name->Text");
                        });
        ...
        public void GetPrintTb()
        {
...

            {
                Dictionary<string, string> file_dic = new Dictionary<string, string>()
                {
                    {"sheet_no","单据号"},
                    {"supcust_from","客户编号"},
                    {"supcust_from_name","客户名称"},
                    {"supcust_to","供应商编号"},
                    {"supcust_to_name","供应商名称"},
                    {"total_amount","对冲金额"},
                    {"oper_id","操作人编号"},
                    {"oper_name","制单人"},
                    {"oper_date","操作日期"},
