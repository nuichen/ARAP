    ...
    class SupFY : IBLL.ISupFY
    {
        ...
        public System.Data.DataTable GetSZList()
        {
            ...
            else
            {
                ...
                {
                    if (row["pay_flag"].ToString() == "1" || row["pay_flag"].ToString() == "0")//原来时1
                    {
        ...
        System.Data.DataTable IBLL.ISupFY.GetList(DateTime date1, DateTime date2, string sup_no)
        {
            ...
            Helper.IRequest req = new Helper.Request();
            var json = req.request("/sup_fy?t=get_list", w.ToString());
            ReadWriteContext.IReadContext r = new ReadWriteContext.ReadContextByJson(json);
            if (r.Read("errId") != "0")
            {
                throw new Exception(r.Read("errMsg"));
        ...
        void IBLL.ISupFY.GetOrder(string sheet_no, out System.Data.DataTable tb1, out System.Data.DataTable tb2)
        {
            Helper.JsonRequest r = new Helper.JsonRequest();
            r.Write("sheet_no", sheet_no);

            r.request("/sup_fy?t=get_order");
        ...
        string IBLL.ISupFY.MaxCode()
        {
            ...
            w.Append("none", "");
            Helper.IRequest req = new Helper.Request();
            var json = req.request("/sup_fy?t=max_code", w.ToString());
            ReadWriteContext.IReadContext r = new ReadWriteContext.ReadContextByJson(json);
            if (r.Read("errId") != "0")
            {
                throw new Exception(r.Read("errMsg"));
        ...
        void IBLL.ISupFY.Add(Model.rp_t_supcust_fy_master ord, List<Model.rp_t_supcust_fy_detail> lines, out string sheet_no)
        {
            ...
            w.Append("lines", tb);
            Helper.IRequest req = new Helper.Request();
            var json = req.request("/sup_fy?t=add", w.ToString());
            ReadWriteContext.IReadContext r = new ReadWriteContext.ReadContextByJson(json);
            if (r.Read("errId") != "0")
            {
                throw new Exception(r.Read("errMsg"));
        ...
        void IBLL.ISupFY.Delete(string sheet_no)
        {
            ReadWriteContext.IWriteContext w = new ReadWriteContext.WriteContextByJson();
            w.Append("sheet_no", sheet_no);
            Helper.IRequest req = new Helper.Request();
            var json = req.request("/sup_fy?t=delete", w.ToString());
            ReadWriteContext.IReadContext r = new ReadWriteContext.ReadContextByJson(json);
            if (r.Read("errId") != "0")
            {
                throw new Exception(r.Read("errMsg"));
        ...
        void IBLL.ISupFY.Check(string sheet_no, string approve_man)
        {
            ReadWriteContext.IWriteContext w = new ReadWriteContext.WriteContextByJson();
            w.Append("sheet_no", sheet_no);
            w.Append("approve_man", approve_man);
            Helper.IRequest req = new Helper.Request();
            var json = req.request("/sup_fy?t=check", w.ToString());
            ReadWriteContext.IReadContext r = new ReadWriteContext.ReadContextByJson(json);
            if (r.Read("errId") != "0")
            {
                throw new Exception(r.Read("errMsg"));
        ...
        void IBLL.ISupFY.NotCheck(string sheet_no, string approve_man)
        {
            ReadWriteContext.IWriteContext w = new ReadWriteContext.WriteContextByJson();
            w.Append("sheet_no", sheet_no);
            w.Append("approve_man", approve_man);
            Helper.IRequest req = new Helper.Request();
            var json = req.request("/sup_fy?t=not_check", w.ToString());
            ReadWriteContext.IReadContext r = new ReadWriteContext.ReadContextByJson(json);
            if (r.Read("errId") != "0")
            {
                throw new Exception(r.Read("errMsg"));
