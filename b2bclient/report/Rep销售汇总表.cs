...
{
    public partial class Rep销售汇总表 : Form
    {
        BLL.IRep销售汇总表 bll;
        private string key = "";
        ...
        private void pageChanged()
        {
            try
            {
                System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.WaitCursor;
                //
                var dt = bll.GetData(key, pageSize, pageIndex, out total);
                //
                dt_excel = dt;
        ...
        private void btn_export_Click(object sender, EventArgs e)
        {
            ...
            {
                // var dt = bll.GetData(key, pageSize, pageIndex, out total);
                dt_excel = bll.GetData(key, 10000, 1, out total);
                ToExcel.toExcel(dt_excel, f.FileName);
            }
        }

        private void Rep销售汇总表_FormClosed(object sender, FormClosedEventArgs e)
        {
            dt_excel = null;
        }
