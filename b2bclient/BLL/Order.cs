...
namespace b2bclient.BLL
{
    class Order:IOrder 
    {
        ...
        List<body.wm_order> IOrder.GetOrderPass(string key, int pageSize, int pageIndex, out int total)
        {
            var req = new Request();
            var json = req.request("/pager?t=get_data", "{\"key\":\"" + key + "\",\"pageSize\":\"" + pageSize + "\",\"pageIndex\":\"" + pageIndex + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
        ...
        List<body.wm_order> IOrder.GetOrderDisable(string key, int pageSize, int pageIndex, out int total)
        {
            var req = new Request();
            var json = req.request("/pager?t=get_data", "{\"key\":\"" + key + "\",\"pageSize\":\"" + pageSize + "\",\"pageIndex\":\"" + pageIndex + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
        ...
        List<body.wm_order> IOrder.GetOrderComplete(string key, int pageSize, int pageIndex, out int total)
        {
            var req = new Request();
            var json = req.request("/pager?t=get_data", "{\"key\":\"" + key + "\",\"pageSize\":\"" + pageSize + "\",\"pageIndex\":\"" + pageIndex + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
        ...
        {
            var req = new Request();
            var json = req.request("/order?t=pass", "{\"ord_id\":\""+ord_id+"\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
                throw new Exception(read.Read("errMsg"));
        ...
        {
            var req = new Request();
            var json = req.request("/order?t=preview", "{\"ord_id\":\"" + ord_id + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
                throw new Exception(read.Read("errMsg"));
        ...
        {
            var req = new Request();
            var json = req.request("/order?t=disable", "{\"ord_id\":\"" + ord_id + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
                throw new Exception(read.Read("errMsg"));
        ...
        void IOrder.GetOrder(string ord_id, out body.wm_order ord, out DataTable lines, out int un_read_num)
        {
            var req = new Request();
            var json = req.request("/order?t=get_order", "{\"ord_id\":\"" + ord_id + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
        ...
        {
            var req = new Request();
            var json = req.request("/order?t=send", "{\"ord_id\":\"" + ord_id + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
                throw new Exception(read.Read("errMsg"));
        ...
        {
            var req = new Request();
            var json = req.request("/order?t=disable_row", "{\"ord_id\":\"" + ord_id + 
               "\",\"row_index\":\""+row_index + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
        ...
        {
            var req = new Request();
            var json = req.request("/order?t=sign_read", "{\"ord_id\":\"" + ord_id + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
                throw new Exception(read.Read("errMsg"));
        ...
        {
            var req = new Request();
            var json = req.request("/order?t=get_order_new", "{\"clear_key\":\"" + clear_key + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
                throw new Exception(read.Read("errMsg"));
        ...
        {
            var req = new Request();
            var json = req.request("/order?t=get_order_pass", "{\"date1\":\"" + date1 + "\",\"date2\":\"" + date2 + "\",\"keyword\":\"" + keyword + "\",\"clear_key\":\"" + clear_key + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
                throw new Exception(read.Read("errMsg"));
        ...
        {
            var req = new Request();
            var json = req.request("/order?t=get_order_disable", "{\"date1\":\"" + date1 + "\",\"date2\":\"" + date2 + "\",\"keyword\":\"" + keyword + "\",\"clear_key\":\"" + clear_key + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
                throw new Exception(read.Read("errMsg"));
        ...
        {
            var req = new Request();
            var json = req.request("/order?t=get_order_complete", "{\"date1\":\"" + date1 + "\",\"date2\":\"" + date2 + "\",\"keyword\":\"" + keyword + "\",\"only_show_no_receive\":\"" + only_show_no_receive + "\",\"clear_key\":\"" + clear_key + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
                throw new Exception(read.Read("errMsg"));
