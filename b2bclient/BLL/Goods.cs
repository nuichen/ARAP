...
namespace b2bclient.BLL
{
    class Goods:IGoods 
    {
            ...
            string large_img_url, string detail_img_url,string themes, string text,string is_show_mall,List<Model.goods_std> lststd)
        {
            ...
            write.Append("datas", dt);
            var json = req.request("/goods?t=change", write.ToString());
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
                throw new Exception(read.Read("errMsg"));
        ...
        {
            var req = new Request();
            var json = req.request("/goods?t=get_info", "{\"goods_id\":\"" + goods_id + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
                throw new Exception(read.Read("errMsg"));
        ...
        {
            var req = new Request();
            var json = req.request("/goods?t=delete", "{\"goods_id\":\"" + goods_id + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
                throw new Exception(read.Read("errMsg"));
        ...
        {
            var req = new Request();
            var json = req.request("/goods?t=stop", "{\"goods_id\":\"" + goods_id + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
                throw new Exception(read.Read("errMsg"));
        ...
        {
            var req = new Request();
            var json = req.request("/goods?t=start", "{\"goods_id\":\"" + goods_id + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
        ...
        {
            var req = new Request();
            var json = req.request("/goods?t=change_price_short", "{\"goods_id\":\"" + goods_id + "\",\"prices\":\""+prices + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
                throw new Exception(read.Read("errMsg"));
        ...
        void IGoods.ChangeStock(string goods_id, string stock_qty)
        {
            ...
            var json = req.request("/goods?t=change_stock", "{\"goods_id\":\"" + goods_id + "\",\"stock_qty\":\"" + stock_qty + "\"}");
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
        ...
        void IGoods.InputSpe(int goods_id, string color, string size,string prices)
        {
            ...
            var json = req.request("/goods?t=input_spe", write.ToString());
            ReadWriteContext.IReadContext read = new ReadWriteContext.ReadContextByJson(json);
            if (read.Read("errId") != "0")
            {
                throw new Exception(read.Read("errMsg"));
