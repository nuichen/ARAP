...
namespace b2bclient
{
    public partial class order_pass : Form
    {
        BLL.IOrder bll;
        private string key = "";
        ...
        public void refreshData()
        {
            try
            {
                ...
                bll.GetOrderPass(date1, date2, keyword,key, out k);
                key = k;
                //
        ...
        private void btn_all_send_Click(object sender, EventArgs e)
        {
            try
            {
                Cursor.Current = Cursors.WaitCursor;
