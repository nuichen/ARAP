...
namespace b2bclient
{
    public partial class order_disable : Form
    {
        ...
        public void refreshData()
        {
            try
            {
                ...
                bll.GetOrderDisable(date1, date2, keyword, key, out k);
                key = k;
                //
        ...
        private void pageChanged()
        {
            ...
            {
                Cursor.Current = Cursors.WaitCursor;
                var dt =  bll.GetOrderDisableDt(key, pageSize, pageIndex, out total);
