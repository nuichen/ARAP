    ...
    public partial class order_all : Form
    {
        ...
        public void refreshData()
        {
            try
            {
                ...
                string only_show_no_receive = "0";
                if (checkBox1.Checked) only_show_no_receive = "1";
                bll.GetOrderComplete(date1, date2, keyword, key, only_show_no_receive, out k);
                key=k;
                //
        ...
        private void pageChanged()
        {
            ...
            {
                Cursor.Current = Cursors.WaitCursor;
                var dt = bll.GetOrderCompleteDt(key, pageSize, pageIndex, out total);
