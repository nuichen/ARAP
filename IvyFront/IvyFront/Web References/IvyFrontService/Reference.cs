...
namespace IvyFront.IvyFrontService {
    using System;
    ...
    public partial class ServiceBase : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public ServiceBase() {
            this.Url = global::IvyFront.Properties.Settings.Default.IvyFront_IvyFrontService_ServiceBase;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/IServiceBase/Request", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlElementAttribute("res", IsNullable=true)]
        public string Request([System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string t, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string pars) {
        ...
        /// <remarks/>
        public void RequestAsync(string t, string pars) {
            this.RequestAsync(t, pars, null);
        }
        
        /// <remarks/>
        public void RequestAsync(string t, string pars, object userState) {
            ...
            this.InvokeAsync("Request", new object[] {
                        t,
                        pars}, this.RequestOperationCompleted, userState);
        }
