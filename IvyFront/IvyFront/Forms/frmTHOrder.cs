...
{
    public partial class frmTHOrder : Form
    {
        ...
        private void pageChanged()
        {
            try
            {
                ...
                all_dt = bll.GetTHInOutSheet(pnldate1.Text, pnldate2.Text, pageIndex, pageSize, out total);
        ...
        private void pnl_search_Click(object sender, EventArgs e)
        {
            ...
            decimal total_amt = 0;
            decimal fact_amt = 0;
            bll.GetTHInOutSheetSum(pnldate1.Text, pnldate2.Text, out order_count, out total_amt,out fact_amt);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                if (e.ColumnIndex == 0)
                {
                    ...
                    {
                        frmCGOrderDetail frm = new frmCGOrderDetail(row.Tag.ToString(),"D");
                        frm.ShowDialog();
                    }
                }
            }
