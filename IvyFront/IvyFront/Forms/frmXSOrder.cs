...
{
    public partial class frmXSOrder : Form
    {
        ...
        private void pageChanged()
        {
            try
            {
                ...
                all_dt = bll.GetSaleSheet(pnldate1.Text, pnldate2.Text, pageIndex, pageSize, out total);
                ...
                foreach (DataRow dr in all_dt.Rows)
                {
                    ...
                    row.Cells[5].Value = Conv.ToDecimal(dr["real_amount"]).ToString("F2");
        ...
        private void pnl_search_Click(object sender, EventArgs e)
        {
            ...
            decimal total_amt = 0;
            decimal fact_amt = 0;
            bll.GetSaleSheetSum(pnldate1.Text, pnldate2.Text, out order_count, out total_amt, out fact_amt);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                if (e.ColumnIndex == 0)
                {
                    ...
                    {
                        frmXSOrderDetail frm = new frmXSOrderDetail(row.Tag.ToString());
                        frm.ShowDialog();
                    }
                }
            }
        ...
        private void btn_reprint_Click(object sender, EventArgs e)
        {
            ...
            if (c_row != null && c_row.Tag != null && c_row.Tag.ToString() != "") 
            {
                ...
                if (ord != null && lines.Rows.Count > 0) 
                {
                    ...
                    if (ord.pay_way == "A") pay_way_str = "现结-现金";
                    else if (ord.pay_way == "W") pay_way_str = "现结-微信";
                    else if (ord.pay_way == "Z") pay_way_str = "现结-支付宝";
