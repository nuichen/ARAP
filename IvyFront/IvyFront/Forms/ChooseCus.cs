...
{
    public partial class ChooseCus : Form
    {
        List<Model.bi_t_supcust_info> cusList = new List<Model.bi_t_supcust_info>();
        List<Model.bi_t_supcust_info> cusListAll = new List<Model.bi_t_supcust_info>();
        ...
        public ChooseCus()
        {
            ...
            try
            {
                ...
                cusList = cusBLL.GetList("");
                foreach (Model.bi_t_supcust_info item in cusList)
                {
                    cusListAll.Add(item);
                }
            }
        ...
        private void con_click(object sender, EventArgs e)
        {
            ...
            if (str == "删除")
            {
                ...
                else
                {
                    ...
                    cusList.Clear();
                    foreach (Model.bi_t_supcust_info item in cusListAll)
                    {
            ...
            for (int i = 0; i < rowNum; i++)
            {
                for (int j = 0; j < colNum; j++)
                {
                    ...
                    else
                    {
                        ...
                        g.DrawString(item.supcust_no + "\r\n" + item.sup_name, new Font("微软雅黑", 12), Brushes.Black, rec, sf);
                        index++;
                    }
                }
            }
        ...
        {
            if (cusList != null && cusList.Count >= 1)
            {
                this.ShowCus(cusList, panel2, ref pageIndex, e.Graphics);
            }
        }
        ...
        private void ChooseCus_Load(object sender, EventArgs e)
        {
            //
