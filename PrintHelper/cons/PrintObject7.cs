...
{
    public partial class PrintObject7 : UserControl,IPrintObject ,ISizeable,IDeleteable,IFontable ,
        IColorable ,IContextAlignAble ,IChangeAreaAble ,IBorderable 
    {
        /// <summary>
        /// 页码
        /// </summary>
        ...
        IPrintObject IPrintObject.Copy()
        {
            ...
            IPrintObject item = new PrintObject7();
            string xml = "<xml>" + ins.xml + "</xml>";
            Helper.ReadXml r = new Helper.ReadXml(xml);
            xml = "<xml>" + r.Read("PrintObject7") + "</xml>";
            item.xml = xml;
            return item;
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawString("第N页，共M页", this.Font, new SolidBrush(this._Color), rec,sf);
        ...
        private void PrintObject7_SizeChanged(object sender, EventArgs e)
        {
            this.Refresh();
        }
