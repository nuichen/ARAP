...
namespace DB
{
    public class DBByHandClose : IDB
    {
        ...
        {
            SqlBulkCopy sbc = new SqlBulkCopy(conn, SqlBulkCopyOptions.Default, tran);
            sbc.BatchSize = 5000;
            sbc.DestinationTableName = ReflectionHelper.GetDataTableNameByModel<T>();
            using (sbc)
            {
                DataTable tb = ReflectionHelper.ModelToDataTable(lis);
        ...
        //------------------------------------------------------------------------------------------------------
        public void InsertShouHuoDan(object obj)
        {
            System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
            cmd.Connection = conn;
            cmd.Transaction = tran;
            ...
            sql = "insert into bi_t_cust_price " + "(" + fields + ")values(" + values + ")";
            cmd.CommandText = sql;
            cmd.Parameters.AddRange(ReflectionHelper.ModelToSqlParameters(obj));
            //
        ...
        public void UpdateShouHuoDan(object obj, string key_fields)
        {
            System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
            cmd.Connection = conn;
            cmd.Transaction = tran;
            ...
            sql = "update bi_t_cust_price " + " set " + fields + " where " + filter;
            cmd.CommandText = sql;
            cmd.Parameters.AddRange(ReflectionHelper.ModelToSqlParameters(obj));
            //
            cmd.ExecuteScalar();
