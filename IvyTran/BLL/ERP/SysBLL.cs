...
namespace IvyTran.BLL.ERP
{
    ...
    {
        body.merchant ISysBLL.GetMerchantByKey(string key)
        {
        ...
        body.merchant ISysBLL.GetMerchantById(string id)
        {
            DB.IDB db = new DB.DBByAutoClose(AppSetting.conn);
        ...
        body.wxpay ISysBLL.GetMerWxpayById(string id)
        {
            DB.IDB db = new DB.DBByAutoClose(AppSetting.conn);
        ...
        body.alipay ISysBLL.GetMerAlipayById(string id)
        {
            DB.IDB db = new DB.DBByAutoClose(AppSetting.conn);
